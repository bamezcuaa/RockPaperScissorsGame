...
function win(userChoice, robotChoice) {
    ...
    result_p.innerHTML = `${convertToWord(userChoice)} beats ${convertToWorld(robotChoice)}, you win!`;
}
...
function lose(userChoice, robotChoice) {
    ...
    userScore_span.innerHTML = userScore;
    robotScore_span.innerHTML = robotScore;
    result_p.innerHTML = `${convertToWord(userChoice)} loses to ${convertToWorld(robotChoice)}, try again!`; 
}

function draw(userChoice, robotChoice) {
    userScore_span.innerHTML = userScore;
    robotScore_span.innerHTML = robotScore;
    result_p.innerHTML = `${convertToWord(userChoice)} same as ${convertToWorld(robotChoice)}, it's a draw!`;
}
